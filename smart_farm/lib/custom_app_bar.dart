...
/// Arquivo: custom_app_bar.dart
/// Componente de AppBar customizado usado pela aplicação. Inclui botões
/// para alternar tema, ir para a home e abrir o painel do simulador.
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  final String? title;
  final FarmState? currentFarm; // Recebe a Farm atual para o simulador
        ...
        IconButton(
          ...
          onPressed: () {
            showModalBottomSheet(
              ...
              backgroundColor: Colors.transparent,
              builder: (context) => SimuladorPanel(
...
class SimuladorPanel extends StatefulWidget {
  final FarmState? initialFarm; // NOVO: Farm que vem da página
...
class _SimuladorPanelState extends State<SimuladorPanel> {
  ...
  void initState() {
    super.initState();
    // Se recebeu uma farm da página, seleciona-a. Senão, pega a primeira.
  ...
  Widget build(BuildContext context) {
    ...
    // Se não houver nenhuma farm disponível, informa o usuário.
    ...
    return Container(
      height:
          ...
          0.85, // Aumentado para caber o novo controlo
        ...
        builder: (context, child) {
          return Column(
            ...
            children: [
              ...
              // NOVO: Simulador do Estado da Planta
              const Text(
                "Estado da Planta (IA):",
